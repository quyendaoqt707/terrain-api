...
func GenerateAccessToken(employee_id, username, user_agent, ip_address string) (string, error) {
...
func GenerateAccessTokenMobile(employee_id, username, user_agent, ip_address string, permission int) (string, error) {
	secret := config.Config("JWT_SECRET_KEY")
	time_expire := config.Config("JWT_EXPIRED_TIME")
